...
$icon_check_all = '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                  class="bi bi-check-all" viewBox="0 0 16 16">
                  <path
                    d="M8.97 4.97a.75.75 0 0 1 1.07 1.05l-3.99 4.99a.75.75 0 0 1-1.08.02L2.324 8.384a.75.75 0 1 1 1.06-1.06l2.094 2.093L8.95 4.992zm-.92 5.14.92.92a.75.75 0 0 0 1.079-.02l3.992-4.99a.75.75 0 1 0-1.091-1.028L9.477 9.417l-.485-.486z" />
                </svg>';
$icon_geo_alt = ' <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="var(--bs-secondary)"
                class="bi bi-geo-alt d-inline d-md-none" viewBox="0 0 16 16">
                <path
                  d="M12.166 8.94c-.524 1.062-1.234 2.12-1.96 3.07A32 32 0 0 1 8 14.58a32 32 0 0 1-2.206-2.57c-.726-.95-1.436-2.008-1.96-3.07C3.304 7.867 3 6.862 3 6a5 5 0 0 1 10 0c0 .862-.305 1.867-.834 2.94M8 16s6-5.686 6-10A6 6 0 0 0 2 6c0 4.314 6 10 6 10" />
                <path d="M8 8a2 2 0 1 1 0-4 2 2 0 0 1 0 4m0 1a3 3 0 1 0 0-6 3 3 0 0 0 0 6" />
              </svg>';
$icon_tag = '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="var(--bs-secondary)"
...
$icon_eyeglasses = '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
...
$icon_cloud_arrow_down = '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
...
$icon_send_arrow_down = '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
...
$icon_hourglass_top = '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
      ...
      <div class="filter-box mb-3">
        <div class="row">
          <div class="col order-1 order-lg-1 col-6 col-xl-auto d-flex  align-items-end gap-2">
            <img src="/Users/user/Sites/localhost/rasadi/wp-content/plugins/rssnews/assets/images/fee-list-logo.svg"
        ...
        <div class="d-flex justify-content-center text-center gap-2 mt-1">
          <span class="text-secondary" style="font-size: 11px;"> ۲۵۶۳ مورد </span>
          <span> - </span>
          <span class="text-secondary" style="font-size: 11px;">۱۲:۳۰ :واکشی بعدی </span>
        </div>
